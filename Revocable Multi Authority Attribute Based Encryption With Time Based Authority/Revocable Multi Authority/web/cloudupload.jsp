    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="cloudupload.jsp">Upload to Cloud </a></li>
...
<%
    ...
    while(rs.next()){
            %><tr><td><%=rs.getString(1)%></td>
                ...
                <td><a href="cloudupload1.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString("owner")%>">  VIew</a> </td>
