...
response.sendRedirect("arc1.jsp?userreg=success");
out.println("Data Consumer Registered Successfully");
}
catch(Exception e1)
{
    response.sendRedirect("arc1.jsp?userreg1=Email Id you Entered already in Use");
