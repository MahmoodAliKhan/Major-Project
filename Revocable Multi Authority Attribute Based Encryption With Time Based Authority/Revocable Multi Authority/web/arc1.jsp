      ...
      <nav id="navbar" class="navbar">
        <ul>
         <li><a class="nav-link scrollto" href="aa2home.jsp">Home</a></li>     
          ...
          <li><a class="nav-link scrollto active" href="arc1.jsp">Revocation</a></li>
  ...
  <%
     //  String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from request where status='Policy Vefied'   ");
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
     <center><br>
                                ...
                                <h6 style="color:white">Policy Revocation</h6><br>
  ...
  <tbody>
    <tr>
      <td><%=rs.getString(1)%></td>
               ...
               <td><a href="rc2.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString("owner")%>&umail=<%=rs.getString("umail")%>">Revocation</a> </td>
