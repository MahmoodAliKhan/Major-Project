      ...
      <nav id="navbar" class="navbar">
        <ul>
         <li><a class="nav-link scrollto" href="uhome.jsp">Home</a></li>
          <li><a class="nav-link scrollto active" href="ucf.jsp">Cloud Files</a></li>
           <li><a class="nav-link scrollto" href="udf.jsp">Download Files</a></li>
  ...
  <%
     //  String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from uploadcloud   ");
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
     <center><br>
                                ...
                                <h6 style="color:white"> View  Cloud Files & Decrypt Key Request Send to CA</h6><br>
  ...
  <tbody>
    <tr>
     <td><%=rs.getString(1)%></td>
        ...
        <td> <a href="uvf2.jsp?filename=<%=rs.getString("filename")%>&data=<%=rs.getString("data").replaceAll("\\+", "%2B")%>&owner=<%=rs.getString("owner")%>&policy=<%=rs.getString("policy")%>&time=<%=rs.getString("time")%>&exp=<%=rs.getString("exp")%>&branch=<%=rs.getString("branch")%>&t1=<%=rs.getString("t1")%>"><font style="color: green; font-size: 16px">Send</a></font> </td>
