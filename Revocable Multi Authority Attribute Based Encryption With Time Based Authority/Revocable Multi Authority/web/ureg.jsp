...
<body>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto  active" href="user.jsp">User</a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
         ...
         <center>
                                <h6 style="color:white">User Register</h6>
                                
                               <form name="form1"  action="uregact.jsp" method="get">
 ...
 <tr>
                    ...
                    <tr>
                    <td>
                        <td><strong><font size="3" color="black">Time: </font></strong></td> 
                        <td><input type="time" name="t1" id="exp" placeholder= Time required style="height:30px; width:200px"></input></td> 
                    </td>
                </tr>  
