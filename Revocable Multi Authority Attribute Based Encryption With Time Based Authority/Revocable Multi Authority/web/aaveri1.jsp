  ...
  <%
     //  String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from request where status='no' and ploicy = 'lifeinstitute' or policy = 'generalhospital'  ");
  ...
  <tbody>
    <tr>
      <td><%=rs.getString(1)%></td>
               ...
               <td><a href="keyverify2.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString("owner")%>&umail=<%=rs.getString("umail")%>&t1=<%=rs.getString("t1")%>">Verify Policy</a> </td>
