...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <li><a class="nav-link scrollto" href="cviewowners.jsp">View Owners</a></li>
                        <li><a class="nav-link scrollto active" href="cviewusers.jsp">View Users</a></li>
  ...
  <%
     //  String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("SELECT *  FROM user   ");
