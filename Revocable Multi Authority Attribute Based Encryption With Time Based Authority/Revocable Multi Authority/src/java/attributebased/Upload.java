...
public class Upload extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println("Data Consumer Name : " + a);
            try {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (isFormField) {
                            ...
                            try {
                               ...
                               pstm.setString(5, a);
                                /*Cloud Start*/
                                File f = new File("C:\\Users\\mahmo\\OneDrive\\Desktop\\input"+fileItem.getName());
                                ...
                                if (i == 1) {
                                    response.sendRedirect("upload.jsp?file=success");
                                } else {
                                    response.sendRedirect("upload.jsp?file1=failed");
                                }
                                con.close();
                            } catch (Exception e) {
