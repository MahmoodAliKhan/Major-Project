                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        if(fileItem.getFieldName().equals("t1")) {
                           t1 = fileItem.getString();
                            System.out.println("File t1" + t1);
        ...
        map.put(policy, attributesArray);
         ...
         output.close();
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into upload (filename, data, owner,skey,policy,time,exp,branch,t1)values(?,?,?,?,?,?,?,?,?)");
                               ...
                               SecretKey secretKey = new SecretKeySpec(bs, "AES");
                                ...
                                pstm.setString(9, t1);
                                /*Cloud Start*/
                                File f = new File("C:\\Users\\mahmo\\OneDrive\\Desktop\\input"+fname);
                               ...
                               // Ftpcon ftpcon = new Ftpcon();
                                ...
                                if (i == 1) {
                                    response.sendRedirect("cloudupload.jsp?upload=File Upload Success");
                                } else {
                                    response.sendRedirect("cloudupload.jsp?upload1=File Upload Failed");
                                }
                                con.close();
                            } catch (Exception e) {
                                 response.sendRedirect("cloudupload.jsp?upload2=File Already Uploaded Failed");
