  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="aa2home.jsp">Home</a></li>     
          <li><a href="a2viewowners.jsp">View Owners</a></li>
          <li><a href="a2viewusers.jsp">View Users</a></li>                        
          <li><a class="nav-link scrollto" href="aaveri1.jsp">Attribute Verify</a></li>
          <li><a href="arc1.jsp">Revocation</a></li>
