...
<body>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="user.jsp">User</a></li>
           <li><a class="nav-link scrollto active" href="aa.jsp">Authority1</a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
         ...
         <center><br>
                                <h6 style="color:white">Authority1 Login</h6><br>
                                
                                <form style="width: 20%;margin-bottom:  40%;" action="aaact.jsp">
